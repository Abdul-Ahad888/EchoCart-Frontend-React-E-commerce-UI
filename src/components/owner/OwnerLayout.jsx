        ...
        <div className="dashboard-layout">
            ...
            <div className={`sidebar ${collapsed ? "collapsed" : ""}`}>
                ...
                <ul className="menu">
                    ...
                    <li className={`${location.pathname === '/owner/users' ? 'active' : ''}`}>
                        <Link to="/owner/users">
                    ...
                    {/* Products Main Tab */}
                    <li className={`${location.pathname.startsWith("/owner/products") ? "active" : ""}`}>
                        <div className="d-flex align-items-center justify-between" style={{ cursor: "pointer" }} onClick={toggleProducts}>
                            <Link to="/owner/products" className="d-flex align-items-center ">
                    ...
                    {!collapsed && productsOpen && (
                        <ul className="submenu">
                            <li className={`${location.pathname === "/owner/products/create-product" ? "active" : ""}`}>
                                <Link to="/owner/products/create-product">
            ...
            <div className="main-area">
                ...
                <div className="admin-navbar">
                    <div className="admin-dash-head">
                        ...
                        <h2 className="font-bold d-inline-block ms-2 ms-sm-4">Owner DashBoard</h2>
                    </div>
                    <div>
                        <ul>
