...
export default function CreateProduct() {
  ...
  return (
    <>
      ...
      {messageToast && (
        <div role="alert" aria-live="assertive" aria-atomic="true" class="toast position-fixed d-block z-3" style={{ bottom: "10px", right: "10px" }} data-bs-autohide="false">
      ...
      <div className="container-fluid p-4">
        ...
        <div className="create-product-header mt-4">
          <h3 className="my-0">Add New Product</h3>
        ...
        <div className="row mt-4">
              ...
              <div className="card-body pt-4">
                ...
                <div className="mb-4">
                  ...
                  >
                    {thumbnailFile ? (
                      <img
                        ...
                        style={{ maxHeight: "260px", maxWidth: "100%", objectFit: "cover" }}
                      />
                    ) : (
                  ...
                  <input
                    id="thumbnailInput"
                    type="file"
                    className={`d-none ${errors.thumbnail ? "is-invalid" : ""}`}
                    accept="image/*"
          ...
          <div className="col-12 col-md-8">
            ...
            <div className="text-end mt-4">
              <button className="btn btn-theme-fill py-1" onClick={handleSubmit}><i className="fa fa-plus me-2"></i> Add Product</button>
            </div>
